...
Transforms key/value pairs based on specific operations where each operation (i.e. a function that responds to `#call`). Does not mutate itself.
...
Transforms key/value pairs based on specific operations where each operation (i.e. a function that responds to `#call`). Mutates itself.
